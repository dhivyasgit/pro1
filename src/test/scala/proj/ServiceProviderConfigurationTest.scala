...
import proj.reader.mycomponent.MyStreamReaderImpl
import proj.transformer.mycomponent.MyStreamTransformerImpl
import proj.writer.mycomponent.MyStreamWriterImpl
